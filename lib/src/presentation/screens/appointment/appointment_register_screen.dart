...
class AppointmentRegister extends StatefulWidget {
  const AppointmentRegister({super.key});

  @override
  AppointmentRegisterState createState() => AppointmentRegisterState();
}

class AppointmentRegisterState extends State<AppointmentRegister> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController _serviceController = TextEditingController();
  final TextEditingController _notesController = TextEditingController();
  DateTime? _selectedDate;
  bool _isLoading = false;
  final RegisterAppointmentService _appointmentService =
  ...
  Future<void> _submitAppointment() async {
    ...
    try {
      final success = await _appointmentService.registerAppointment(
        date: _selectedDate!,
